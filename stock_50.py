...
st.write("NIFTY 50 | NIFTY 100 | NIFTY 500")
...
# Load Data
if index_option == "NIFTY50":
    file = "NIFTY50_1995_to_Feb_2026.csv"
elif index_option == "NIFTY100":
    file = "NIFTY100_2005_to_Feb_2026.csv"
else:
    file = "NIFTY500_2005_to_Feb_2026.csv"
